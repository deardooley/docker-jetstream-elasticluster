...
class OpenStackCloudProvider(AbstractCloudProvider):
    ...
    :param str project_id: id of the project to use
    ...
    def __init__(self, username, password, project_name, project_id,
                 ...
                 request_floating_ip=False, network_ids=None,
        ...
        if identity_api_version == '2':
            ...
            auth = loader.load_from_options(auth_url=self._os_auth_url,
                                            ...
                                            project_id=self._os_project_id)
    ...
    def start_instance(self, key_name, public_key_path, private_key_path,
                       ...
                       username=None, node_name=None, network_ids=None, **kwargs):
        ...
        * run the instance with the given properties
        ...
        nics = [{'net-id': '10a92c55-bbc5-4713-94c0-175bf66ea489', 'v4-fixed-ip': ''}]
    ...
    def __setstate__(self, state):
        ...
        self._os_project_id = state['project_id']
